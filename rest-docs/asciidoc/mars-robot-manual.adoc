...
Path parameters:
include::{snippets}/mars-robot-web/target/generated-snippets/robot-command-move-to-right-success/path-parameters.adoc[]
...
Path parameters:
include::{snippets}/mars-robot-web/target/generated-snippets/robot-command-move-to-left-success/path-parameters.adoc[]
